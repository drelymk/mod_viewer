...
import {
  ...
  resetRigJoint,
  resetRigPose,
  selectRigJoint, setRigActiveLimbRole, setRigLimbAnchor,
  redetectRigLimb, clearRigLimbMapping, flipRigLimbBend, setRigIkEnabled,
...
rendererReady.then(ready => {
  ...
  Object.defineProperties(window.modViewer, {
    ...
    setRigLimbAnchor: {value: setRigLimbAnchor},
    redetectRigLimb: {value: redetectRigLimb},
